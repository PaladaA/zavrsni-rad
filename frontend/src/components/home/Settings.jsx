...
const Settings = () => {
  ...
  const changeNameFun = (e) => {
    ...
    fetch(`http://localhost:3000/settings/change`, {//minjamo u bazi ime
      method: "PATCH",
      ...
      .then((data) => {
        ...
        setUser({ name: name, id: user.id, email: user.email }); //odah vidljivo novo ime nakon updatea
      })
  ...
  return (
    <div id="settings">
      ...
      {user.name == "admin" && <AdminSettings deleteAccountFun={deleteAccountFun}/>}
